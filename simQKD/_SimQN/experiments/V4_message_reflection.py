...
def main():
    print_experiment_header("V4: Message Reflection", "SimQN")
    ...
    if not SIMQN_AVAILABLE:
        ...
        print_result_verdict(results, 4, "SimQN", symbol=SYMBOL_UNSUPPORTED)
        return

    # Test 1: MAC and authentication check
    print("\n--- Test 1: MAC and authentication check ---")
    results["notes"].append(
        "SimQN has no built-in MAC or authentication. "
    ...
    print_result_verdict(results, 4, "SimQN", symbol=symbol)
